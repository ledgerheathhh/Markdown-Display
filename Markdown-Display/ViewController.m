...
//    NSString *html = [MMMarkdown HTMLStringWithMarkdown:markdown error:&error];
    ...
    // 在创建 DTHTMLAttributedStringBuilder 时启用表格支持
    NSDictionary *options = @{
        ...
        // Use the correct table attributes
        @"DTDefaultTableBorderWidth": @(1.0),
        @"DTDefaultTableBorderColor": [UIColor lightGrayColor],
        @"DTDefaultTableCellPadding": @(5.0)
    };
...
//    // 使用 DTAttributedTextView 而不是普通 UITextView
...
//    [self.view addSubview:textView];
    ...
    NSString *htmlString = @"<html><body>"
                           ...
                           "<tr><th style='background-color:#f2f2f2;'>标题1</th><th style='background-color:#f2f2f2;'>标题2</th></tr>"
                           "<tr><td>数据1</td><td>数据2</td></tr>"
                           "</table>"
                           "</body></html>";
    htmlData = [htmlString dataUsingEncoding:NSUTF8StringEncoding];

    // 使用 DTHTMLAttributedStringBuilder
